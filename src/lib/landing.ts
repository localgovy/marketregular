...
export const CATEGORIES: CategoryDef[] = [
  {
    ...
    lede: "Ontario fruit and vegetables bought straight from the people who grew them, and the vendors that bring them in each week.",
    scope: "both",
  },
  {
    tag: "organic",
    ...
    lede: "Growers who farm certified organic or low-spray, and the markets where they set up.",
    scope: "both",
  },
  {
    tag: "vegan",
    title: `Vegan vendors at ${LAUNCH_CITY} farmers' markets`,
    heading: `Vegan vendors at ${LAUNCH_CITY} farmers' markets`,
    lede: "Plant-based bakers, cheesemakers and cooks, and which market to find each of them at.",
    scope: "both",
  },
  {
    tag: "bakery",
    title: `Bread and bakery vendors at ${LAUNCH_CITY} farmers' markets`,
    heading: `Bread and bakery vendors at ${LAUNCH_CITY} farmers' markets`,
  ...
  {
    tag: "crafts",
    title: `Artisan and craft vendors at ${LAUNCH_CITY} farmers' markets`,
    heading: `Artisan and craft vendors at ${LAUNCH_CITY} farmers' markets`,
    lede: "Makers selling ceramics, textiles, jewellery and woodwork alongside the food.",
    scope: "both",
  },
  {
    tag: "meat",
    title: `Butchers and meat vendors at ${LAUNCH_CITY} farmers' markets`,
    heading: `Butchers and meat vendors at ${LAUNCH_CITY} farmers' markets`,
    lede: "Farms selling their own beef, pork, lamb and poultry direct, with no distributor in between.",
    scope: "both",
  },
  {
    tag: "cheese",
    title: `Cheese vendors at ${LAUNCH_CITY} farmers' markets`,
    heading: `Cheese vendors at ${LAUNCH_CITY} farmers' markets`,
    lede: "Ontario dairies and cheesemongers, and the markets they set up at.",
    scope: "both",
  },
  {
    tag: "flowers",
    title: `Flower vendors at ${LAUNCH_CITY} farmers' markets`,
    heading: `Flower vendors at ${LAUNCH_CITY} farmers' markets`,
  ...
  },
  {
    ...
    lede: "Roasters and coffee bars pouring at the market.",
    scope: "both",
  },
  {
    tag: "caribbean",
