...
/** National Flag of Canada — 2:1, red–white–red, 11-point maple. Red follows `currentColor`. */
export function MapleMark({ className, ...props }: MarkProps) {
  return (
    <svg
...
/** Facebook glyph for outbound listing links. */
